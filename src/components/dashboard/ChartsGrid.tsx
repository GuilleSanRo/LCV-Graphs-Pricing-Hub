...
export function ChartsGrid({ rows, evolutionRows }: { rows: Row[], evolutionRows?: Row[] }) {
  ...
  function getMakeOrGroup(make: string) {
    if (groupMode === "group" && ["Fiat", "Citroen", "Peugeot", "Opel"].includes(make)) {
      return "Stellantis";
    }
    return make;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
        ...
        <Card title="Monthly Payment Over Time" sub="avg Monthly Payment by Wave" empty={evolution.length < 2}>
